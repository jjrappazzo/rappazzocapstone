...
# accident_raw <- read_csv('C:/Users/jjrap/OneDrive/Desktop/SUNY Geneseo/Spring 2023/Data Analytics Capstone/sample_accidents.csv')
...
rmarkdown::paged_table(accident_raw %>% head(20))
```
...
# Models (Make linear, ridge, lasso, random forest using every variable before using the 11 variables for everything) -Both?
